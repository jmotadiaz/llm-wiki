              ...
              {filteredWarnings.length === 0 ? (
                ...
                <div className="divide-y divide-gray-50 dark:divide-gray-800">
                  {filteredWarnings.map(w => (
                    <div key={w.id} className="group flex items-start gap-3 p-3 hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-0.5">
                          ...
                          {w.pageId && (
                            <span className="text-[10px] font-medium px-1.5 py-0.5 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded">Page ID: {w.pageId}</span>
                          )}
                        </div>
